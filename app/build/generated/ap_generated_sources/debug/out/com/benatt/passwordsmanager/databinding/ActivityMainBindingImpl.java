...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.mainViewModel == variableId) {
            setMainViewModel((com.benatt.passwordsmanager.views.MainViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMainViewModel(@Nullable com.benatt.passwordsmanager.views.MainViewModel MainViewModel) {
