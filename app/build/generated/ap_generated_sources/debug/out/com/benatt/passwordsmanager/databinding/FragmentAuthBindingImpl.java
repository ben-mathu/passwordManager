...
public class FragmentAuthBindingImpl extends FragmentAuthBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.authViewModel == variableId) {
            setAuthViewModel((com.benatt.passwordsmanager.views.auth.AuthViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setAuthViewModel(@Nullable com.benatt.passwordsmanager.views.auth.AuthViewModel AuthViewModel) {
