...
public class BillingManager implements PurchasesUpdatedListener {
    ...
    private void startConnection() {
        billingClient.startConnection(new BillingClientStateListener() {
            ...
            public void onBillingServiceDisconnected() {
                Log.e(
                        TAG,
                        "onBillingServiceDisconnected -> Error while connecting to billing client"
                );
            }
            ...
            public void onBillingSetupFinished(@NonNull BillingResult billingResult) {
                if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK)
                    Log.d(
                            TAG, "onBillingSetupFinished -> Billing Client connection successful"
                    );
            }
        });
    }
    ...
    public void launchBillingFlow(Activity activity, BillingCallback callback) {
        ...
        billingClient.queryProductDetailsAsync(
                params, (billingResult, productDetailsList) -> {
                    if (billingResult.getResponseCode() != BillingClient.BillingResponseCode.OK){
    ...
    public void checkPayment(BillingCallback callback) {
        ...
        billingClient.queryPurchasesAsync(
                params, (billingResult, list) -> acknowledgePurchases(list));
    }
}
